...
"""Cards 2 - ランダムにカードを選ぼう！
テーマ：
- Dictionaryの中身をランダムに選ぶ方法を理解


手順：
- random.choice(<ランダムに選びたいリスト>) => ランダムに選ばれたitemの配列順番が返される
- 返された配列番号でそのリストからアイテムを呼び出す
- ランダムにスーツを選ぶ
- ランダムに数字を選ぶ


課題：　
- 別のスーツを表示（現在はclubsなのでdiamondsに変更する)
