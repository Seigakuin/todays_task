...
class Box(arcade.Sprite):
	def __init__(self):
		super().__init__()
		self.texture = arcade.make_soft_square_texture(100, arcade.color.GOLD,
													   255, 200)
...
class Snow(arcade.Sprite):
	def __init__(self, center_x, center_y, radius, speed):
		...
		# このtextureにcircle入れる
		self.texture = arcade.make_soft_circle_texture(self.radius,
													   arcade.color.WHITE)
...
class MyGame(arcade.Window):
	...
	def __init__(self):
		...
		super().__init__(SCREEN_WIDTH, SCREEN_HEIGHT, "ARCADE EXAMPLE 9")
	...
	def on_update(self, delta_time):
		...
		hit_list = arcade.check_for_collision_with_list(self.box,
														self.snow_list)
