...
class Rock(Drawable):
    ...
    def __init__(self, pos, size):
        ...
        self.image = pygame.image.load(os.path.join(current_path, "rock.png"))
...
class Ship(Drawable):
    ...
    def __init__(self):
        ...
        self.accel = 0
        self.explode = False
        self.image = pygame.image.load(os.path.join(current_path, "ship.png"))
        self.bang = pygame.image.load(os.path.join(current_path, "bang.png"))
...
def main():
    ...
    score = 0
    back_x, back_y = 0, 0
    back_image = pygame.image.load(os.path.join(current_path, "bg.png"))
    ...
    while True:
        ...
        if game_over:
            if len(rocks) == 0:
                ...
                SURFACE.blit(message_over, (0, message_rect.centery))
                # keymap = []
                shots = []
                rocks = []
                ship = Ship()
